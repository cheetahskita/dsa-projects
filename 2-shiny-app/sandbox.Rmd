...
```{r}
colnames(dflist[[1]])[2] <- "what.is.your.age."
colnames(dflist[[1]])[4] <- "what.country.do.you.work.in."
colnames(dflist[[1]])[9] <- "if.you.have.a.mental.health.issue.do.you.feel.that.it.interferes.with.your.work.when.NOT.being.treated.effectively."
...
```{r}
verified.qs = list("what.is.your.age.",
                   "gender",
...
# OUTPUT FILES
```{r}
write_csv(df.tot, "dashboard.csv")
```
